...
<menu>
  ...
  <item cmd="/aiqa-generatetestcases or generate test cases or test cases" action="Load and follow skill from {project-root}/AI-QA-FRAMEWORK/skills/test-case-generation/prompt.md">/aiqa-generatetestcases &lt;story-file&gt; — Generate Arabic XLSX + MD test cases (Phase 2)</item>
  <item cmd="/aiqa-generatee2e or generate e2e or playwright" workflow="{project-root}/AI-QA-FRAMEWORK/workflows/generate-e2e/workflow.yaml">/aiqa-generatee2e &lt;story-file&gt; — Scaffold Playwright POM + specs (Phase 3)</item>
